...
select idinfouser from infouser where usuarios_idusuarios=2

select idinscricao from inscricao where usuarios_idusuarios=2 and evento_idevento=2;
...
where inscricao.usuarios_idUsuarios=2;


UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='usuarios';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='titulos';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='palestrante';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='inscricao';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='infouser';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='infoPalestrante';
UPDATE SQLITE_SEQUENCE SET SEQ=0 WHERE NAME='evento';
